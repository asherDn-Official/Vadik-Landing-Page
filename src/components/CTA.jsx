...
const CTA = () => {
  ...
  return (
    <section id="cta" ref={ref} className="section-spacing bg-gradient-primary text-white">
              ...
              <div className="bg-gradient-primary-soft p-8 md:p-10 flex flex-col justify-center">
                ...
                <div className="space-y-6">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-800">Free 14-day trial</h4>
                      <p className="text-gray-600 mt-1">No credit card required to start.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="font-medium text-gray-800">Guided onboarding</h4>
                      <p className="text-gray-600 mt-1">We'll help you set up your first campaign.</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600 mt-1">Access to our customer success team.</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="mt-8 pt-6 border-t border-primary-100">
                  <blockquote className="italic text-gray-700">
                    "We saw a 40% increase in repeat purchases within the first month."
                  </blockquote>
                  <div className="mt-4 flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Fashion Retailer, Delhi</p>
                    </div>
                  </div>
                </div>
              </div>
