...
const HowItWorks = () => {
  ...
  const features = [
    ...
    },
    {
      title: "Omni-Presence",
      description:
        "Collect and update customer data across all touchpoints – WhatsApp, QR code, walk-ins.",
    ...
    },
    {
      ...
      description:
        "Create a central profile for every customer with communication history, preferences & feedback.",
    ...
    },
    {
      title: "Understanding",
      description:
        "Segment by lifestyle, interest, profession, or product love.",
      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        >
          ...
          <p className="text-lg text-gray-600">
            With our <strong>FOCUSED</strong> Touch approach, managing customer
            relationships becomes simple and effective.
          </p>
        ...
        >
          {features.slice(0, 4).map((feature, index) => (
            ...
            >
              <div
                className={`w-14 h-14 ${feature.color} rounded-full flex items-center justify-center text-white mb-4`}
              >
                {feature.icon}
              </div>
        ...
        >
          <p className="text-lg md:text-xl font-medium text-primary-600">
            Our <stong>FOCUSED</stong> approach transforms how businesses
            connect with their customers, creating lasting relationships that
            drive growth.
          </p>
        </motion.div>
      </div>
